...
wp_register_ability( 'dollypack/wp-remote-request', array(
	'label'       => 'WP Remote Request',
	...
	'execute_callback'    => 'dollypack_execute_wp_remote_request',
...
function dollypack_execute_wp_remote_request( $input ) {
	$url = $input['url'] ?? '';
